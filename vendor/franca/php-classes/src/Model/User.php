<?php
    ...
    class User extends Model{
        ...
        const SESSION = "User";
        const SECRET = "aoAlcance750milM";
        const SECRET_IV = "aoAlcance750milMVII";
        ...
        public static function getForgot($email, $inadmin = true){
            ...
            if (count($results) === 0){
                throw new \Exception("Não foi possível recuperar a senha"); //barra se regere ao namespace principal
            }else{
                $data = $results[0];
                ...
                if(count($results2) === 0){
                    ...
                    if ($inadmin === true) {
                        $link = "http://www.franca.com.br/adm/forgot/reset?code=$code";
                    } else {
                        $link = "http://www.franca.com.br/forgot/reset?code=$code";
                        
                    }				
                    $mailer = new Mailer($data['desemail'], $data['desperson'],
                                         "Redefinição de senha", "forgot",
                    array(
                        "name"=>$data['desperson'],
                        "link"=>$link
                    ));				
