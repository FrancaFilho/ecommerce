...
use \franca\Model\Cart;
use \franca\Model\Address;
...
$app->post("/register", function(){
	...
	$user->save();
	User::login($_POST['email'], $_POST['password']); //logando
	header('Location: /checkout');
	exit;
});
...
$app->get("/boleto/:idorder", function($idorder){
	...
	$dadosboleto["instrucoes3"] = "- Em caso de dúvidas entre em contato conosco: suporte@franca.com.br";
	$dadosboleto["instrucoes4"] = "&nbsp; Emitido pelo sistema Projeto Loja franca E-commerce - www.franca.com.br";
