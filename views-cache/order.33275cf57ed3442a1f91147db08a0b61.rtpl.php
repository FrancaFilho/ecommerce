...
<div class="content-wrapper">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="/adm/orders/<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">Pedido N°<?php echo htmlspecialchars( $order["idorder"], ENT_COMPAT, 'UTF-8', FALSE ); ?></a></li>
    </ol>
    </section>
    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            ...
            De
            <address>
                <strong>França Store </strong><br>
                Taguatinga Sul<br>
                CSB 4, Lotes 4 a 6 - DF<br>
                Telefone: (61) 99874-0692<br>
                E-mail: miltondsw@gmail.com
            </address>
            </div>
            <!-- /.col -->
            <div class="col-sm-4 invoice-col">
        ...
        <div class="row no-print">
            <div class="col-xs-12">
                <button type="button" onclick="window.location.href = '/adm/orders/<?php echo htmlspecialchars( $order["idstatus"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/status'" class="btn btn-default pull-left" style="margin-left: 5px;">
